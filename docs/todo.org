...
* TODO v 2.0
** TODO Chords change mode
* TODO Network
** DONE Host doesnt exist
** DONE Pair doesnt exist
** TODO Pair disconnected
** DONE Decouple controller from init
** TODO Network controller
** TODO Network controller tests
** TODO Design communication protocol
** DONE Make connection on log click
** DONE Search icon for midi connections
** DONE Fix icons
** DONE set background of icons grey depending on panel in view
** DONE tests using launchpad input
